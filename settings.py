...
def main():
    ...
    category_percentages = {"Food": 25, "Housing": 25, "Shopping": 15, "Entertainment": 10, "Healthcare": 10,"Transportation": 5, "Other": 10}
    ...
    for category, percentage in category_percentages.items():
        ...
        if category not in st.session_state.thresholds or not isinstance(st.session_state.thresholds[category], (int, float)):
            st.session_state.thresholds[category] = int((max_threshold * percentage) / 100 * 0.7)
